        ...
        >
            ...
            <section id="call-api" className="text-gray-900 mb-8">
                ...
                <ol className="list-decimal ml-10">
                    <li className="mb-4">
                        <p>
                            Every request must either specify an API key (with the key parameter) or provide
                            an OAuth 2.0 token.
                        </p>
                        <p>
                    ...
                    <li className="mb-4">
                        <p className="mb-4">
                            You <strong>must</strong> send an authorization token for every insert, update,
                            and delete request. You must also send an authorization token for any request that
                            retrieves the authenticated user's private data.
                        </p>
                        <p>
                            In addition, some API methods for retrieving resources may support parameters that
                            require authorization or may contain additional metadata when requests are
                            authorized. For example, a request to retrieve a user's uploaded videos may also
                            contain private videos if the request is authorized by that specific user.
                        </p>
                    </li>
                    <li>
                        <p className="mb-4">
                            The API supports the OAuth 2.0 authentication protocol. You can provide an OAuth
                            2.0 token in either of the following ways:
                        </p>
                        <ul className="list-disc ml-8 ">
                            <li className="mb-4">
                                Use the <span className="code">access_token</span> query parameter like this:{" "}
                                <span className="code">?access_token=oauth2-token</span>
                            </li>
                            <li className="mb-4">
            ...
            <section id="resources-types" className="mb-8">
                <div className="flex items-center gap-4 group mb-8">
                    ...
                    <button
                        className=" hidden group-hover:block"
                        onClick={() => {
                            navigator.clipboard.writeText(window.location.origin + "/#resources-types");
                            alertHandler();
                        }}
                    >
                        <IoLinkOutline size={22} className="hover:text-blue-600" />
                ...
                <section id="activities" className="mb-4">
                    <div className="flex items-center gap-4 group mb-6">
                        ...
                        <button
                            className=" hidden group-hover:block"
                            onClick={() => {
                                navigator.clipboard.writeText(window.location.origin + "/#activities");
                                alertHandler();
                            }}
                        >
                            <IoLinkOutline size={22} className="hover:text-blue-600" />
                    ...
                    <p className="mb-4">
                        An <span className="code">activity</span> resource contains information about an
                        action that a particular channel, or user, has taken on YouTube. The actions reported
                        in activity feeds include rating a video, sharing a video, marking a video as a
                        favorite, uploading a video, and so forth. Each <span className="code">activity</span>{" "}
                        resource identifies the type of action, the channel associated with the action, and
                        the resource(s) associated with the action, such as the video that was rated or
                        uploaded.
                    </p>
                    <p className="mb-4">
                    ...
                    <div className=" text-sm text-gray-900 border-y border-gray-200 mb-8">
                        ...
                        <div className="grid  table-cols border-b border-gray-200">
                            ...
                            <div className="p-2 text-black">
                                ...
                                example, you can retrieve events associated with a particular channel or with
                        ...
                        <div className="grid  table-cols  ">
                            ...
                            <div className="p-2 text-red-500">
                                <strong>Note</strong>: This method has been deprecated and is no longer
                                supported.
                            </div>
                        </div>
                    </div>
                ...
                <section id="captions" className="mb-4">
                    ...
                    <p className="mb-4">
                        A <span className="code">caption</span> resource represents a YouTube caption track. A
                ...
                <section id="channel-banners" className="mb-4">
                    <div className="flex items-center gap-4 group mb-6">
                        ...
                        <button
                            className=" hidden group-hover:block"
                            onClick={() => {
                                navigator.clipboard.writeText(window.location.origin + "/#channel-banners");
                                alertHandler();
                            }}
                        >
                            <IoLinkOutline size={22} className="hover:text-blue-600" />
                ...
                <section id="channel-sections" className="mb-4">
                    <div className="flex items-center gap-4 group mb-6">
                        ...
                        <button
                            className=" hidden group-hover:block"
                            onClick={() => {
                                navigator.clipboard.writeText(window.location.origin + "/#channel-sections");
                                alertHandler();
                            }}
                        >
                            <IoLinkOutline size={22} className="hover:text-blue-600" />
                ...
                <section id="comment-threads" className="mb-4">
                    <div className="flex items-center gap-4 group mb-6">
                        ...
                        <button
                            className=" hidden group-hover:block"
                            onClick={() => {
                                navigator.clipboard.writeText(window.location.origin + "/#comment-threads");
                                alertHandler();
                            }}
                        >
                            <IoLinkOutline size={22} className="hover:text-blue-600" />
                ...
                <section id="guide-categories" className="mb-4">
                    <div className="flex items-center gap-4 group mb-6">
                        ...
                        <button
                            className=" hidden group-hover:block"
                            onClick={() => {
                                navigator.clipboard.writeText(window.location.origin + "/#guide-categories");
                                alertHandler();
                            }}
                        >
                            <IoLinkOutline size={22} className="hover:text-blue-600" />
